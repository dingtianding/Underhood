            ...
            <div className='splash' onClick={this.hideModal}>
                <div className='splash-disclaimer-modal-container'>
                    <div className='splash-disclaimer-modal'>
                        <div className='splash-disclaimer-modal-text'>
                            ...
                            * Underhood is a clone of the website Robinhood created as as student project at App Academy. <br /><br /> 
                            * This website does not perform any real transactions.<br /><br />
                            ...
                            / If a stock search returns no result without yielding a console error, please try again in <u className='underline'>1 - 2 mins</u> as the count of request is registered on a running basis. <br /><br />
                            / If graphs are loaded with x and y labels, please try <u className='underline'>refreshing the page.</u> I am working on a loading/buffering feature to address this. <br /><br />
                ...
                <div className="first-splash-component">
                    <div className="splash-app-description">
                        ...
                        <div>
                                <h2>
                                    <a href="https://github.com/dingtianding/Underhood/blob/main/README.md" target="_blank" className="underline">
                ...
                <p>
                    <span>
                        Click&nbsp;<a href="https://github.com/dingtianding/Underhood/" target="_blank"><span className="underline">here
                        </span> 
                </a>
